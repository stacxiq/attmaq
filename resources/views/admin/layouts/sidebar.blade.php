...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        <ul class="side-menu">
            ...
            <li class="slide">
<<<<<<< HEAD
                <a class="side-menu__item" href="{{ route('admin.student.index') }}">
                    ...
                    <span class="side-menu__label"> المشتركين </span></a>
            </li>
...
<<<<<<< HEAD
            <li class="slide">
                <a class="side-menu__item" href="{{ route('custom_notification.index') }}">
                    ...
                    <span class="side-menu__label">الاشعارات المخصصه</span></a>
            </li>



            <li class="slide">
                <a class="side-menu__item" href="{{ route('admin.faq.index') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9.879 7.519c1.171-1.025 3.071-1.025 4.242 0 1.172 1.025 1.172 2.687 0 3.712-.203.179-.43.326-.67.442-.745.361-1.45.999-1.45 1.827v.75M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9 5.25h.008v.008H12v-.008z" />
                    </svg>


                    <span class="side-menu__label">الاسئلة الشائعة </span></a>
            </li>

            <li class="slide">
                <a class="side-menu__item" href="{{ route('admin.banner.index') }}">
                    ...
                    <span class="side-menu__label"> الاعلانات </span></a>
            </li>
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ route('admin.settings.index') }}">
                    ...
                    <span class="side-menu__label"> الاعدادات </span></a>
            </li>
