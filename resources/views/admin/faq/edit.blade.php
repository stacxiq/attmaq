                ...
                <div class="card-body pt-0">
                    <form class="form-horizontal" action="{{ route('admin.faq.update') }}" method="POST" >
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="hidden" name="id" value="{{ $faq->id }}" class="form-control" id="inputName"
                                           required>
                                    <input type="text" name="question" value="{{ $faq->question }}" class="form-control" id="inputName" placeholder="عنوان السؤال"
                                           required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="text" name="answer"  value="{{ $faq->answer }}" class="form-control" id="inputName" placeholder="الجواب"
                                           required>
                                </div>
                            </div>
                        </div>
