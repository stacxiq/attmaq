                ...
                <div class="card-body pt-0">
                    <form class="form-horizontal" action="{{ route('admin.sessions.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="date" name="start-date" class="form-control" id="inputName" placeholder="تاريخ الحلقة"
                                           required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="time" name="start-time" class="form-control" id="inputName" placeholder="موعد الحلقة"
                                           required>
                                </div>
                            </div>
